...
class RandomPlayer(GamePlayer):
    ...
    def choose_action(self, state: ObservableGameState, actions: ActionList, history: Optional[List[ObservableGameState]] = None) -> int:
        ...
        while True:
            try:
                ...
                if 0 <= choice < len(sorted_actions):
                    ...
                    print(f"Invalid choice. Please enter a number between 0 and {len(sorted_actions) - 1}")
            except ValueError:
